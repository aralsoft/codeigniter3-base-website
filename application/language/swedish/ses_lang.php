...
$lang['ses_change_password_body'] = 'Kär<user_name> ,<br /><br /> Vi meddelar dig att någon har ändrat din<common_app_name> lösenord. Om detta inte var du, använd följande länk för återställning av lösenord för att ändra ditt lösenord.<br /><br /><url> konto/glömt_lösenord';
